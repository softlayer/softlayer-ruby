...
The SoftLayer API Client for Ruby is a library for connecting to and calling the routines of "The SoftLayer API":http://sldn.softlayer.com/wiki/index.php/The_SoftLayer_API from the "%{color:#9E0803}*Ruby*%":http://www.ruby-lang.org programming language.
