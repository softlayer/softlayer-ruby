...
describe SoftLayer::VLANFirewall do
  ...
  describe "firewall routing changes" do
    ...
    it "rejects other parameters (particularly true and false)" do
      ...
      expect{ mock_firewall.change_routing_bypass!(true) }.to raise_error
      expect{ mock_firewall.change_routing_bypass!(false) }.to raise_error
      expect{ mock_firewall.change_routing_bypass!(:apply_firewall_rules) }.to raise_error
      expect{ mock_firewall.change_routing_bypass!(:bypass_firewall_rules) }.to raise_error
      expect{ mock_firewall.change_routing_bypass!("route_around_firewall") }.to raise_error
      expect{ mock_firewall.change_routing_bypass!("route_through_firewall") }.to raise_error
      expect{ mock_firewall.change_routing_bypass!(nil) }.to raise_error
      expect{ mock_firewall.change_routing_bypass!(1) }.to raise_error
      expect{ mock_firewall.change_routing_bypass!(0) }.to raise_error
    end
  end
end