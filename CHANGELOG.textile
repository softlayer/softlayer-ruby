*2.0*
* Switched the Ruby API client from the SoftLayer REST API to the SoftLayer SOAP API. SOAP is handled with the "Savon":http://savonrb.com Heavy metal SOAP client.
